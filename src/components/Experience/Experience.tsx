...
const experiences = [
  {
    ...
    description:
      "Developed and shipped responsive frontend features, improving web performance by 25%. Collaborated with backend engineers to integrate REST APIs, ensuring seamless data flow. Optimized cross-browser compatibility increasing user engagement by 15%, and contributed to a LinkedIn automation extension.",
  ...
  },
  {
    ...
    period: "2024 - Present",
    description:
      "Developing scalable web applications and digital solutions for diverse clients using the MERN stack and Next.js. Architecting database structures and creating responsive, meaningful user experiences.",
  ...
  },
  {
    ...
    period: "2023 - Present",
    description:
      "Actively contributing to open-source projects, focusing on developer tools and UI libraries. enhancing code quality through rigorous testing and documentation.",
    ...
    >
      <div className="max-w-7xl w-full mx-auto flex flex-col md:flex-row !gap-16 md:!gap-24">
        ...
        <div className="md:w-1/3 md:sticky md:top-32 h-fit">
          <h2 className="text-sm uppercase tracking-[0.3em] font-bold text-violet-500 !mb-6">
            Career Path
          </h2>
            ...
            {experiences.map((exp, index) => (
              <div key={index} className="experience-item relative group">
                ...
                <div className="flex flex-col md:flex-row md:items-baseline gap-4 !mb-4">
                  ...
                  <span className="text-violet-400 font-medium tracking-wide">
                    {exp.company}
                  </span>
                </div>

                <span className="block text-sm font-bold text-gray-500 uppercase tracking-wider !mb-6">
                  {exp.period}
                </span>
                ...
                <div className="flex flex-wrap !gap-3">
                  {exp.tech.map((t, i) => (
                    <span
                      key={i}
                      className="text-xs font-semibold !px-3 !py-1 rounded-full bg-white/5 border border-white/10 text-gray-400 group-hover:border-violet-500/30 transition-colors"
                    >
                      {t}
                    </span>
                  ))}
