...
const BioSection = () => {
  ...
  return (
    <section
      ref={bioTextRef}
      className="bio-section relative overflow-hidden bg-black !py-32 md:!py-56 px-6 md:px-12 z-10 selection:bg-violet-500/30"
    >
            ...
            <div className="reveal-desc max-w-2xl">
              ...
              <div className="flex flex-wrap gap-8 items-center">
                <a
                  ...
                  target="_blank"
                  className="reveal-btn group relative px-10 py-5 bg-violet-600 text-white font-bold rounded-xl overflow-hidden transition-all duration-300 hover:shadow-[0_0_40px_rgba(139,92,246,0.5)] active:scale-95"
                >
                  <span className="relative z-10 flex items-center gap-3 text-xs uppercase tracking-widest">
                    Get Resume
                    <svg
                      className="w-4 h-4 transition-transform group-hover:translate-y-[-2px] group-hover:translate-x-[2px]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                >
                  <span className="text-[10px] uppercase tracking-[0.5em] font-black border-b border-white/10 group-hover:border-violet-400 pb-1 transition-all">
                    Works
                  </span>
