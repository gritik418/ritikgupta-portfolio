...
const Contact = () => {
  ...
  useGSAP(
    () => {
      ...
      const createShootingStar = () => {
        ...
        trail.className =
          "absolute w-10 h-[1px] bg-gradient-to-r from-transparent to-white/80 pointer-events-none";
  ...
  return (
    <section
      ref={containerRef}
      className="min-h-screen bg-black flex flex-col items-center text-white !pt-32 !pb-20 relative overflow-hidden justify-center"
    >
      <div className="max-w-7xl mx-auto !px-6 w-full grid grid-cols-1 lg:grid-cols-2 !gap-16 lg:!gap-24 items-center">
        ...
        <div className="!space-y-12">
          <div className="contact-header !space-y-6">
            <h4 className="text-violet-500 font-bold tracking-[0.2em] uppercase text-sm">
              Contact Me
            </h4>
            ...
            <p className="text-xl text-gray-400 leading-relaxed max-w-md">
              Have a project in mind? Looking to hire? Or just want to discuss
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 !gap-6">
            {contactDetails.map((item, index) => (
              ...
              >
                <div
                  className={`text-3xl !mb-4 ${item.color} group-hover:scale-110 transition-transform duration-300 w-12 h-12 flex items-center justify-center rounded-lg bg-black/20 text-center`}
                >
                  {item.icon}
                </div>
                <h3 className="text-gray-400 text-sm uppercase tracking-wider font-bold !mb-1">
                  {item.title}
                </h3>
